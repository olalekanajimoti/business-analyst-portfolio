...
| Rules analysis | Converted tax concepts into routes, decision tables and controlled requirements | Taash |
| Risk management | Identified privacy, compliance, operational and adoption risks | Taash, Verdaso, Healthcare facilities |
| Root-cause analysis | Traced duplicate charges to a false payment-failed state and currency errors to blended reporting | MyTicketSeller |
| Product ownership | Owned a live platform from first build to production, prioritising and accepting every release | MyTicketSeller |
| Journey and conversion design | Mapped where booking intent was lost and designed a one-tap booking funnel | Komfort Place Signature |
| Analytics design | Specified first-party click events and a dashboard showing booking taps by page and hour | Komfort Place Signature |
| Quality analysis | Evaluated factual accuracy, completeness and instruction adherence | AI evaluation |

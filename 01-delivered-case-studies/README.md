...
| [MyTicketSeller](myticketseller-event-ticketing/README.md) | Unreliable payments, blended currencies and uncontrolled door access on a live ticketing platform | Product ownership, root-cause analysis, requirements, UAT and security risk |
| [Taash](taash-tax-automation/README.md) | Tax rules users cannot interpret or apply to their own situation | Rules analysis, decision tables, traceability and regulatory change control |
| [Komfort Place Signature](komfort-place-signature-digital-growth/README.md) | Booking intent lost between social media and a conversation | Journey mapping, conversion design, analytics and content governance |
